...
class StarViewController: UIViewController {
    ...
    func setUpTableView() {
        ...
        models1.append(FastModel1(imageName: "혼밥대왕", title: "혼밥대왕 인천송도1호점", star: "4.9", review: "(100+)", menu: "제주흑돼지 김치볶음, 만두 흑돼지 김치찌개", OrderPay: "6,900원", deliveryPay: "500원~", deliveryTime: "31~46분"))
        models1.append(FastModel1(imageName: "송토육개장", title: "송토 육개장", star: "4.8", review: "(50+)", menu: "육개장, 굴육개장", OrderPay: "15,000원", deliveryPay: "3,000원", deliveryTime: "49~64분"))
        models1.append(FastModel1(imageName: "소꼬리전문점무궁", title: "소꼬리전문점 무궁", star: "4.8", review: "(50+)", menu: "꼬리구이, 로제꼬리", OrderPay: "20,000원", deliveryPay: "0원~", deliveryTime: "39~54분"))
        models1.append(FastModel1(imageName: "꾸꾸삼겹", title: "꾸꾸삼겹 인천송도점", star: "4.8", review: "(50+)", menu: "[브랜드3관왕] 냉면2500원, [가성비맛집] 꾸꾸실속", OrderPay: "8,000원", deliveryPay: "1,000원", deliveryTime: "68~83분"))
        models1.append(FastModel1(imageName: "돈포레스트", title: "돈 포르세트 청청 제주 돼지숯불구이", star: "4.2", review: "(10+)", menu: "제주 삼겹살, 제주 흑돼지 오겹살", OrderPay: "30,000원", deliveryPay: "0원", deliveryTime: "40~55분"))
        models1.append(FastModel1(imageName: "쫄면주는삼겹본능", title: "쫄면주는삼겹본능by놀부 송도 스마트밸리점", star: "4.9", review: "(50+)", menu: "구이삼겹 1인 도시락, 구이삼겹 2인 도시락", OrderPay: "15,000원", deliveryPay: "2.500원", deliveryTime: "40~55분"))
